# Webhook Setup Master Prompt (Local/Private + ngrok) — Hermes vs OpenClaw (researched)
...
- Both support webhooks and hooks. OpenClaw exposes this via Webhooks Plugin + Gateway routes/secret binding; Hermes exposes webhook flows directly in this runtime/tooling model.
...
- The real distinction here is operational setup style, not “has webhooks vs no webhooks.”
